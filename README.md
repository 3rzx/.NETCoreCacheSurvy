...
Use api MakeKeyValue string in Origin Key File will be separated every 5 char as a key, pairing by a GUID as value. These keys are be stored in Key File separated with \n. These values are be stored in value File separated with \n.
